...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/MOON-CODES/mrcool",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/music_support4")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/untold_coder")
